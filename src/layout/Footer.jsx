  ...
  return (
    <div className="bg-[#333333] px-5 py-10 lg:py-[60px] lg:px-20 text-white flex flex-col md:flex-row justify-between gap-10 font-lato ">
      <Image
        ...
        width={500}
        height={500}
        className="absolute right-0 top-[10500px]  w-[148px] h-[148px] md:w-[221px] md:h-[221px] lg:w-[240px] lg:h-[240px] md:top-[7650px] lg:top-[5570px] lg:right-8 z-10 "
      />
      <Image
        ...
        width={500}
        height={500}
        className="absolute left-0 top-[10550px] z-0  w-[61px] h-[57px] md:w-[111px] md:h-[103px] md:top-[7670px] lg:top-[5650px]  lg:w-[118px] lg:h-[109px]"
      />
      <div className="space-y-5">
        <div className="bg-white w-[132px] md:w-[232px] py-1 md:py-2 px-[23px] md:px-[47px] flex justify-center rounded-[5px] ">
          <Image
            src="/images/logo.png"
            alt="Logo"
            width={500}
        ...
        <div className="font-lato gap-4  md:gap-8 text-[14px] md:text-xl font-medium  items-center flex flex-wrap">
          <Link href="/">Home</Link>
        ...
        <div className=" flex-col justify-end gap-5 md:hidden flex">
        ...
        <p className="lg:pt-[50px]">terms & services</p>
        <p>Greenify @ all right reserved 2023</p>
      </div>

      <div className=" flex-col justify-end gap-5 hidden md:flex">
        <h2 className="text-lg md:text-[24px] font-bold ">Contact us</h2>
        <div className="flex items-center gap-3">
          <i class="ri-phone-line md:text-[24px]"></i>
          <span className="md:text-[24px]">+91 123456789</span>
        ...
        <div className="flex items-center gap-3">
          <i class="ri-map-pin-line md:text-[24px]"></i>
          <span className="md:text-[24px]">102-Complex, Xyz Road <br className="md:hidden lg:block" /> City name, State, 136458</span>
        </div>
      </div>
    </div>
  );
