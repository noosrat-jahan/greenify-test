...
export default function Newsletter() {
  return (
    <div className=" text-center flex flex-col items-center w-full px-5 md:px-[110px] py-10 lg:py-[60px] lg:px-[100px] font-montserrat newsletter text-[#333333] gap-10 relative ">
      ...
      <Image
        ...
        width={800}
        height={800}
        className="absolute w-[53px] h-[46px] md:w-[75px] md:h-[65px] top-[-25px] md:top-[-55px] lg:top-[-45px] left-[25px] z-20 "
      />
      <Image
      ...
      <div className="w-[95%] lg:w-[80%]   mx-auto bg-white rounded-[20px] flex flex-col-reverse lg:flex-row justify-between z-10">
        <Image
          ...
          width={700}
          height={700}
          className="h-[292px] md:w-[524px] md:h-[438px] lg:w-[360px] lg:h-auto object-cover w-full rounded-[20px]"
        />
